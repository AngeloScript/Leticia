...
export const metadata: Metadata = {
  title: "210 Receitas Sem Glúten por Letícia Dias",
  description: "Descubra como ter uma vida saudável, comendo pratos deliciosos e livres de glúten todos os dias.",
};
